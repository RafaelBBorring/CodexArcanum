...
# Domínio público do Railway (usado no HTTP-Referer)
RAILWAY_DOMAIN = os.getenv("RAILWAY_PUBLIC_DOMAIN", "https://codexarcanum-production.up.railway.app")
...
def generate():
    ...
    headers = {
        ...
        "HTTP-Referer":  RAILWAY_DOMAIN          # domínio real lido da variável de ambiente
    }
...
if __name__ == '__main__':
    ...
    print(f"  Referer: {RAILWAY_DOMAIN}")
    print("=" * 52)
